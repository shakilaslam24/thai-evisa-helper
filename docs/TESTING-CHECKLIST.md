...
- [ ] উপরে লোগো ও ট্যাগলাইন, নিচে **তিনটা ফোন নম্বর ও অফিসের ঠিকানা** দেখায়
- [ ] ফোন নম্বরে চাপ দিলে ফোনের ডায়ালার খোলে
...
- [ ] Invoice-এ কোম্পানির নাম, ঠিকানা, **তিনটা ফোন নম্বরই**, terms দেখাচ্ছে
- [ ] মাথায় লোগো ঠিকভাবে বসেছে — চারপাশে সাদা/নেভি বাক্স নেই
- [ ] ট্যাগলাইন **Fly Beyond Your Dreams** দেখাচ্ছে
...
**QR কোড (ট্র্যাকিং লিংক):**

- [ ] ইনভয়েসের নিচে ডানদিকে **QR কোড** আছে, পাশে লেখা আছে কী করতে হবে
- [ ] **ফোনের ক্যামেরা দিয়ে স্ক্রিনের QR স্ক্যান করুন** → ট্র্যাকিং পেজ খোলে
- [ ] ইনভয়েসটা **প্রিন্ট করে কাগজের QR স্ক্যান করুন** → একইভাবে কাজ করে
- [ ] Settings → **Tracking link & QR** → প্রিভিউতে কোড ও লিংক দেখা যায়
- [ ] **Open the tracking page** বাটন ঠিক পেজে নিয়ে যায়
- [ ] **Public tracking link**-এ নিজের ডোমেইন বসিয়ে Save → ইনভয়েসে ফিরে গিয়ে
      নতুন QR স্ক্যান করলে **নতুন ঠিকানায়** যায়
- [ ] ঘরটা আবার খালি করে Save → সিস্টেম যে ঠিকানায় চলছে সেটাতেই ফিরে যায়
- [ ] **QR code on invoices → Hide** করলে ইনভয়েস থেকে কোড উধাও হয়
- [ ] **Wording beside the QR code** বদলালে ইনভয়েসে নতুন লেখা আসে (বাংলাতেও)
...
**যে কোন স্টাফ পুরো দিনের কাজ করতে পারে (`rafiq@dreamfly.local` / `demo-staff-2026`):**
- [ ] Lead যোগ করতে পারে
- [ ] Follow-up ও Meeting দিতে পারে
- [ ] Lead → Customer বানাতে পারে
- [ ] Case file খুলতে ও status বদলাতে পারে
- [ ] **Invoice তৈরি করতে পারে**
- [ ] **ডিউ পেমেন্ট কালেক্ট করতে পারে** (invoice খুলে → Record payment)
- [ ] B2B partner যোগ করতে পারে
- [ ] Document আপলোড করতে পারে
- [ ] **Settings** মেনু দেখতে পায় না
- [ ] **Staff Performance** মেনু দেখতে পায় না

**Accounts (`accounts@dreamfly.local` / `demo-accts-2026`):**
- [ ] Invoice ও Payment তৈরি করতে পারে
- [ ] **Lead, Customer, File-ও তৈরি করতে পারে** — শুধু হিসাবের কাজে আটকে নেই
- [ ] পুরো কোম্পানির টাকার হিসাব দেখে, কিন্তু pipeline-এ শুধু নিজেরটা

**অন্যের কাস্টমারের বিল নেওয়া যায়:**
- [ ] সুমি দিয়ে লগইন → উপরের সার্চে রফিকের কাস্টমারের invoice নম্বর লিখুন
- [ ] invoice খোলে, **Record payment** কাজ করে
  (কাউন্টারে যে থাকে সে-ই টাকা নেয় — তাই বিল খোলা সবার জন্য খোলা)
- [ ] কিন্তু Invoices তালিকার **TOTAL BILLED** এ রফিকের বিক্রি যোগ হয় না

**স্টাফ শুধু নিজের বিক্রি দেখে:**
- [ ] দুইজন স্টাফ বানান, প্রত্যেকের নামে আলাদা কাস্টমার ও ফাইল দিন
- [ ] দুজনের ফাইলেই আলাদা invoice বানান
- [ ] প্রথম স্টাফ দিয়ে লগইন → **Invoices-এ শুধু তার নিজেরটা** দেখায়
- [ ] **Payments**-এও শুধু নিজেরটা
- [ ] **Reports → Invoice report**-এ শুধু নিজেরটা
- [ ] ড্যাশবোর্ডের "Total billed" আর Invoices পেজের সংখ্যা **একই**
- [ ] Reports ড্রপডাউনে **Staff performance ও Partner-wise নেই** (১০টা রিপোর্ট)
- [ ] অ্যাড্রেস বারে সরাসরি `#/staff` বা `#/settings` লিখলে
      **"Not available for your role"** পেজ আসে — কোন লাল এরর নয়
- [ ] অ্যাডমিন/ম্যানেজার/অ্যাকাউন্টস তিনজনই **পুরো কোম্পানির** হিসাব দেখে
